                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <a href="<?php echo e(route('investments.show', $investment['id'])); ?>" class="btn btn-primary btn-sm float-right mr-2 font"><i class="bi bi-eye"></i></a>
                        </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\iContracts\resources\views/investments/index.blade.php ENDPATH**/ ?>